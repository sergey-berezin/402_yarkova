...
namespace ConsoleApp_Lab_1
{
    ...
    class Program
    {
        ...
        {
            //var hobbit = " ";
            /*string filePath = "C:\\Users\\Admin\\source\\repos\\ConsoleApp_Lab_1\\ConsoleApp_Lab_1\\file_for_text.txt";
            ...
            {
                Console.WriteLine($"Произошла ошибка ввода-вывода: {e.Message}");
            }
            catch (UnauthorizedAccessException e)
            {
                Console.WriteLine($"У вас нет разрешения на доступ к файлу: {e.Message}");
            }
            catch (Exception e)
            {
            ...
            foreach (var question in inputQuestions)
            {
                ...
                //string? queastion_about_hobbit = Console.ReadLine();
                ...
                //var sentence = "{\"question\": \"@CGI\", \"context\": \"@CTX\"}".Replace("@CTX", hobbit);
                ...
                //"C:\\Users\\Admin\\source\\repos\\ConsoleApp13\\ConsoleApp13\\bert-large-uncased-whole-word-masking-finetuned-squad.onnx"
                // Create input tensor.
        ...
        /*public static async void Download_Network()
        {
            ...
            {
                //Console.WriteLine($"Файл {destinationPath} существует");
            }
            else
            {
        ...
        public static async Task Download_Network(CancellationToken cancellationToken)
        {
            string fileUrl = "https://storage.yandexcloud.net/dotnet4/bert-large-uncased-whole-word-masking-finetuned-squad.onnx"; // Замените на свою ссылку
            string destinationPath = "C:\\Users\\Admin\\source\\repos\\ConsoleApp_Lab_1\\ConsoleApp_Lab_1\\bert-large-uncased-whole-word-masking-finetuned-squad.onnx"; // Замените на путь, куда сохранить файл
        ...
        { 
            ...
            Download_Network(cancellationTokenSource.Token);
            /*foreach (string str in Answer_Generate(inputText, question1, question2))
            {
